...
Invoke-WebRequest -UseBasicParsing -Uri "http://0.0.0.0:8080/upload" -Method Post -Headers @{"X-Filename"="results.zip"} -InFile "./results.zip" -ContentType "application/octet-stream"
